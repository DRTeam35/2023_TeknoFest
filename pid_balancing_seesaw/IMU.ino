...
struct IMU_Values GetIMU_Values() {
  ...
  if (mpu.dmpGetCurrentFIFOPacket(fifoBuffer)) { // Get the Latest packet 
    ...
    o.CurrentOrientation.YawAngle = (ypr[0] * 180 / M_PI)+180;
    o.CurrentOrientation.RollAngle = (ypr[1] * 180 / M_PI * -1)+180; //-1 for changing rotation
    o.CurrentOrientation.PitchAngle = (ypr[2] * 180 / M_PI)+180;
